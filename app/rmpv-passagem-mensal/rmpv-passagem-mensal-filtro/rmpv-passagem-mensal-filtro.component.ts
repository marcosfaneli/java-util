...
@Component({
  selector: 'app-rmpv-passagem-mensal-filtro',
  templateUrl: './rmpv-passagem-mensal-filtro.component.html',
  styleUrls: ['./rmpv-passagem-mensal-filtro.component.css']
})

export class RmpvPassagemMensalFiltroComponent implements OnInit {
  ...
  constructor(private passagem: FiltroService, private route: ActivatedRoute) {
